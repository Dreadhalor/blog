Here's an interactive live code example of this component. It's a little awkward because I had to put the entire thing in a single file & if you edit the Tailwind it doesn't generate new classnames, but it should give you a good idea of how it works.
